...
const Navigation = ({ megaMenuHandler, modalHandler }) => {
  ...
  return (
    <div className="shadow-md">
      <div className="w-11/12 m-auto gap-5 flex lg:block justify-between items-center py-5">
        <div
          className="lg:hidden rounded-sm w-7 h-6 flex items-center cursor-pointer gap-5"
        ...
        <div className="gap-5 flex justify-center md:justify-between items-center">
          <p
            onMouseEnter={megaMenuHandler}
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="relative w-full">
              ...
              <input
                type="text"
                className="bg-gray-100 w-full lg:w-96 pr-2 py-3 pl-10 rounded-full border border-gray-900 focus:border-gray-900 outline-0"
